...
export default function ArchivePage() {
  ...
  // Filter archived items (items with isArchived flag)
  const archived = knowledgeItems.filter((item) => item.isArchived);
          ...
          <div className="max-w-7xl mx-auto flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-0.5">
                {sortedArchived.length} archived item{sortedArchived.length !== 1 ? "s" : ""}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="p-8 max-w-7xl mx-auto">
            ...
            >
              <p className="text-sm text-blue-700">
                Archived items are hidden from your main view but can be restored anytime.
              </p>
            </motion.div>
            ...
            {isLoading ? (
              ...
              <Card className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Items you archive will appear here. You can restore them anytime.
                </p>
                <Link href="/dashboard">
              ...
              <KnowledgeGrid items={sortedArchived} />
            )}
          </div>
        </div>
      </main>
