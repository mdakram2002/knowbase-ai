...
export default function RecentPage() {
  ...
  // Get recent items (last 7 days or top 20 items)
  const sevenDaysAgo = new Date();
  sevenDaysAgo.setDate(sevenDaysAgo.getDate() - 7);

  const recent = knowledgeItems.filter(
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-0.5">
                  {sortedRecent.length} item{sortedRecent.length !== 1 ? "s" : ""} from the last 7 days
                </p>
              </div>
            </div>
            ...
            {isLoading ? (
              ...
              <Card className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  You haven't added anything recently. Start creating!
                </p>
                <Link href="/dashboard/knowledge/new">
              ...
              <KnowledgeGrid items={sortedRecent} />
            )}
          </div>
        </div>
      </main>
