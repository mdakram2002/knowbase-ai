...
export default function LinksPage() {
  ...
  const links = knowledgeItems.filter((item) => item.type === "link");
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-0.5">
                  {sortedLinks.length} link{sortedLinks.length !== 1 ? "s" : ""} • {stats.links} total
                </p>
              </div>
            </div>
            ...
            {isLoading ? (
              ...
              <Card className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Start by saving useful links to build your resource library.
                </p>
                <Link href="/dashboard/knowledge/new">
                  <Button>Save your first link</Button>
                </Link>
              </Card>
            ) : (
              <KnowledgeGrid items={sortedLinks} />
            )}
          </div>
        </div>
      </main>
